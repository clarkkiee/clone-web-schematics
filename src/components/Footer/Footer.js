...
function Footer() {
  return (
    <>
        <div className='flex flex-col bg-[rgb(33,33,33)] p-4 py-12 gap-4'>
            <div className='flex'>
                <div className='p-2'>
            ...
            <div className='flex flex-col gap-2'> 
                <h3 className='mt-4 text-slate-500 font-bold'>QUICK LINK</h3>
                <ul className='flex flex-col gap-2'>
            ...
            <div>
                <div className='flex w-full justify-center my-2 pt-4 px-4 pl-4 border-t-[1px] border-slate-600 gap-5'>
            ...
            <h3 className='mx-auto text-md text-white'>&copy; Schematics 2023 x UBS Gold</h3>
        </div>
    </>
  )
}
